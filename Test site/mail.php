<?php
include_once'libs/simcraft_lib.php';
//$data = $sc->getMailData($pg3)
$userNm = "Paul";
$data = [];
...
if($lang == 'fr'){
	$data['title']			= "Activez votre compte sur ".$sc->domain;
	$data['preheader']		= "Cliquez sur le lien present dans ce mail pour activer votre compte sur ".$sc->domain;
	...
	$data['ml_end']			= "Bienvenue dans la communauté, et à très vite sur <a href='".$sc->domain."'>".$sc->domain."</a> !";
