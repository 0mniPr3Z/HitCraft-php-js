...
<html>
  <head>
    ...
    <title><?=$this->vocab?></title>
    <style><?php include'mail/css/1.css'?></style>
  </head>
  <body style="<?php include'mail/css/2.css'?>">

    <span class="preheader" style="<?php include'mail/css/3.css'?>">
		This is preheader text. Some clients will show this text as a preview.
	</span>

    <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="body" style="<?php include'mail/css/4.css'?>" width="100%" bgcolor="#f6f6f6">
      <tr>
        <td style="<?php include'mail/css/5.css'?>" valign="top">&nbsp;</td>
        <td class="container" style="<?php include'mail/css/6.css'?>" width="580" valign="top">
          <div class="content" style="<?php include'mail/css/7.css'?>">
            <table role="presentation" class="main" style="<?php include'mail/css/8.css'?>" width="100%">
