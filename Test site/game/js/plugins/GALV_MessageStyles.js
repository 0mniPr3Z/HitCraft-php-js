...
Game_System.prototype.initialize = function() {
	...
	this._messageWindowSkin = "Window_0";
	this.SC_window = "Window_0";
	this._messageArrowGraphic = "WindowArr_0";
};
...
Game_Interpreter.prototype.command101 = function() {
	...
	if (ispop) {
		Galv.Mstyle.img('Window_2','Arrow1');
		...
		Galv.Mstyle.img("Window_" + $gameVariables.value(41),'Arrow1');
		Galv.Mstyle.thisEvent = null;
		Galv.Mstyle.target = null;
	};
