...
<a href="<?=$data['ml_actlink']?>" target="_blank" style="border: solid 1px #3498db; border-radius: 5px; box-sizing: border-box; cursor: pointer; display: inline-block; font-size: 14px; font-weight: bold; margin: 0; padding: 12px 25px; text-decoration: none; text-transform: capitalize; background-color: #3498db; border-color: #3498db; color: #ffffff;">
<?=$data['ml_action']?>
</a>
...
<?=$data['ml_unsub']?>
					<a href="<?=$data['ml_unsublink']?>" style="text-decoration: underline; color: #999999; font-size: 12px; text-align: center;">
